...
//Com esta notaçao @Log4j2, podemos usar o log para registrar informaçoes no console e em arquivos de log, sem precisar instanciar.
@Log4j2
@RestController
...
public class CourseController {
    ...
    public ResponseEntity<Object> saveCourse(@RequestBody @Valid CourseDto courseDto){
        ...
        //Copiando as propriedades do courseDto para o courseModel usando o BeanUtils
